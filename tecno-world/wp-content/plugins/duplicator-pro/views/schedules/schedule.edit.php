...
<table class="form-table">
    ...
    <tr valign="top">
        ...
        <td>
			...
			<a href="admin.php?page=duplicator-pro-templates" style="margin-top:2px" class="button button-small" title="<?php DUP_PRO_U::_e("Templates") ?>" target="_blank"><i class="fa fa-clone"></i> <?php DUP_PRO_U::_e("Templates"); ?></a>
